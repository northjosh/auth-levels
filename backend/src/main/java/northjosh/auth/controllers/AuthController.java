...
import northjosh.auth.services.AuthService;
import northjosh.auth.services.JwtService;
import northjosh.auth.services.TotpService;
...
public class AuthController {
    ...
    final private TotpService totpService;
    ...
    @Autowired
    public AuthController(AuthService authService, JwtService jwtService, TotpService totpService, UserRepo userRepo,
